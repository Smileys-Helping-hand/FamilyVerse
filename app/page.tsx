  ...
  return (
    <main className="min-h-screen bg-[#1A1A1A] flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <section className="z-10 text-center mt-24 mb-16">
        ...
        <button
          className="px-8 py-4 text-2xl font-bold rounded-full bg-[#00FF66] text-[#1A1A1A] shadow-lg hover:bg-[#00F0FF] transition-all animate-glow"
      ...
      <section className="z-10 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-24">
        <div
          className="bg-gray-900 rounded-xl p-6 shadow-lg flex flex-col items-center cursor-pointer hover:bg-gray-800 transition-all"
        ...
        <div
          className="bg-gray-900 rounded-xl p-6 shadow-lg flex flex-col items-center cursor-pointer hover:bg-gray-800 transition-all"
          onClick={() => handleNavigate('/quartermaster')}
        >
          <span className="text-4xl mb-2">🎒</span>
